...
def build_admin_home_gallery(section, default_slug, fallback_images, fallback_title):
    # Temporary production bypass: Render is missing the admin gallery table.
    # Keep the public homepage alive with curated fallback media until migrations
    # are safely applied in production.
